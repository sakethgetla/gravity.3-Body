...
public class Main extends Canvas implements Runnable{
	...
	int dirRight = 3 , dirLeft =2 , dirDown = 1 , dirUp = 0 , selectionNo = 0 ;
	...
	int textBoxSpeed = 1 ,panelWidth = 0 , panelHeight = 0 , textBoxWidth = HEIGHT /10 ,
			textBoxHeight = HEIGHT /10,	targetAccel[] = new int [4] , targetVel = textBoxSpeed *4;
  ...
  */
	...
	public void keyPressed(KeyEvent e) {
		...
		case KeyEvent.VK_SPACE:
			for (int i = 0 ; i <=9; i++){
				if (targetLoc[0] > textBoxLoc[i][0] - textBoxWidth && 
						targetLoc[0] < textBoxLoc[i][0] + textBoxWidth ) {
