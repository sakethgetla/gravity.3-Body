...
//if (totDist > ((ballHeight/2)+ (sunHeight/2))) {	
				...
				if (futureBallCentre[1]-(ballHeight/2) <0 || futureBallCentre[1]+(ballHeight/2) > this.getHeight()) {
					ballVel[1] *= -1 ;
				}
	...
	// sun movement ///////////////////////////
				...
				if (futureSunCentre[1]-(sunHeight/2) <0 || futureSunCentre[1]+(sunHeight/2) > this.getHeight()) {
					sunVel[1] *= -1 ;
				}
